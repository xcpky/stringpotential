...
#define DIMRE (24)
#define ZI (0.3)
#define FACPI (g_pi*g_pi/f_pi/f_pi/12)
#include <complex.h>
...
static inline double complex z0(double complex E, double complex m,
                                double complex p1, double complex p2,
                                double m0) {
  return (csquare(E - 2 * m - (p1 * p1 + p2 * p2) / (2 * m)) - m0 * m0 -
          p1 * p1 - p2 * p2) /
         (-2 * p2 * p1);
}
...
double complex Vpiu(struct OME ome, double complex E, double complex p1,
                    double complex p2, double m1, double gam1, double m2,
...
static inline double complex quadreal(struct OME ome, double complex E,
                                      double complex p1, double complex p2,
                                      double m1, double gam1, double m2,
                                      double gam2, double m3, double gam3,
                                      double m4, double gam4, double m0,
                                      double fac) {
  ...
  for (size_t i = 0; i < DIMRE; i += 1) {
    ...
    auto Dint = FACPI * fac * (1 / D1 + 1 / D2) / (2 * Epi(z, p1, p2, m0)) *
...
static inline double complex quadii(struct OME ome, double complex E,
                                    ...
                                    double gam2, double m3, double gam3,
                                    double m4, double gam4, double m0,
                                    double fac, double complex _z, double complex offset) {
  double complex res = 0;
  for (size_t i = 0; i < DIMRE; i += 1) {
...
static inline double complex OME_00(struct OME ome, double complex E, double complex p, double complex pprime) {
  return Vpiu(ome, E, p, pprime, m_B_star, gamma_B_star, m_B, 0, m_B_star, gamma_B_star, m_B, 0, m_pi, -9) + Vpiu(ome, E, p, pprime, m_B_star, gamma_B_star, m_B, 0, m_B_star, gamma_B_star, m_B, 0, m_eta, -1);
}
